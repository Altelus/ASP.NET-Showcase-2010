<%@ Page Title="Lab 3" Language="C#" MasterPageFile="~/templates/labs.master" AutoEventWireup="true"
    CodeFile="lab3.aspx.cs" Inherits="labs_lab3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" runat="Server">
    <asp:Panel ID="pnlGetInfo" runat="server" Height="300px" BorderStyle="None">
        First Name:
    ...
    <asp:Panel ID="pnlMail" runat="server" Visible="False" BorderStyle="None">
